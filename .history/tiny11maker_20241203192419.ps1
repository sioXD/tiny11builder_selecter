...
switch ($choice) {
    "1" {
        Write-Host "Option 1 ausgewählt: tiny11."
    ...
    "2" {
        Write-Host "Option 2 ausgewählt: tiny11 mit edge."
    ...
    "3" {
        Write-Host "Option 3 ausgewählt: Manuelle Auswahl der zu entfernenden Komponenten."
    ...
    if ($global:selectedComponents) {
        ...
        foreach ($component in $global:selectedComponents) {
            switch ($component) {
                ...
                'OneDrive' { Write-Host "OneDrive-Funktion aufrufen"; $var += "OneDrive"; $var += "OneDrive_Backup" }
                'Load_reg' { Write-Host "Reg wird geloaded"; $var += "Load_reg" } #! should always be selected
